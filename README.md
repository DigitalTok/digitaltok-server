...
| 이름 | 포지션 | 담당 API (기능) |
| :---: | :---: | :--- |
| [**이정헌**](https://github.com/LeeJeongHeon02) | Backend | • Template 도메인 담당  <br>• 서버 구축 및 CI/CD |
| [**송정은**](https://github.com/jeun66) | Backend | • Images 도메인 담당 <br>• 이미지 -> 바이너리 데이터 변환 로직 개발 |
| [**이승주**](https://github.com/dudulic) | Backend | • Auth, User 도메인 담당 <br>• 토큰 관리 및 재발급 |
| [**조성하**](https://github.com/cdth12345) | Backend | • Device, User 도메인 담당 <br>• 내 프로필 조회 및 편집 |
